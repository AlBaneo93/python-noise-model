...
def pca(data: list[list], before_pca_data_path: str, after_pca_data_path: str, pc_value_path: str, mean_value_path: str,
        pca_result_path: str) -> ndarray:
    """

    :param pca_result_path:
