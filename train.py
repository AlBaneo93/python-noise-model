...
def get_train_dataset_noise() -> tuple:
    ...
    # NOTE : 2D array여야 함
    kph_dataset_reshaped = pca(kph_dataset, Constants.noise_pca_data_path, Constants.noise_after_pca_data_path)
...
def get_test_dataset_noise() -> tuple:
    # Test dataset
    print('[LOAD] Extracting features from test dataset: {}'.format(Constants.path_test))
